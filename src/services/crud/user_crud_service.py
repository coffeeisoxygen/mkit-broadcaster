...
class UserCrudService:
    ...
    async def create_user(self, user_data: UserCreate) -> UserOut:
        ...
        if existing:
            logger.bind(username=user_data.username).warning("Duplicate user creation.")
        ...
        logger.bind(username=user_data.username).info("Created user.")
        return UserOut.model_validate(user)
